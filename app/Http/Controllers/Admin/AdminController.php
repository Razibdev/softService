...
class AdminController extends Controller
{
  ...
  //end Course
    ...
    public function userEdit()
    {
        ...
        // return $subscription;
        return view('admin.userEdit', ['user' => $user, 'paidshop' => $paidshop,'unpaidshop' => $unpaidshop,'ubes' => $userBalanceEdits, 'user_update_informations' => $user_update_informations, 'subscription' => $subscription, 'notes' => $notes]);
    }
    ...
    {
      menuSubmenu('softcomapplicationlist', 'softcomapplicationlist');
