...
// {
//     return  $this->service()->products_count; // it returns 24
// }
    ...
    public function getServiceProfilesCountAttribute(){
        return $this->liveProducts()->count();
    }
    ...
    // public  function isMyFavouriteStatic()
    // {
    //     return $this->favourite()->where('user_id',\Auth::id())->count();
    // }
