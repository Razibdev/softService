...
Route::group(['middleware' => ['auth'], 'prefix' => 'mypanel'], function () {
    ...
    // Route::get('/user/dashboard/fetchdata', 'User\UserDashborad/UserDashboardController@usershopDataFetch');

    Route::get('/user/dashboard/fetchdata', [
        'uses' => 'User\UserDashborad\UserDashboardController@usershopDataFetch'
    ]);


    Route::get('/user/dashboard/fetchitem/{id}', [
    ...
    Route::get('/user/dashboard/fetchfavorite/{id}', [
        'uses' => 'User\UserDashborad\UserDashboardController@usershopFavorite'
    ]);


    Route::get('/get-service-all-product', [
        'uses' => 'User\UserDashborad\UserDashboardController@getAllProductVueCart'
    ]);


    Route::match(['get', 'post'],'/user-service-product-cart', [
        'uses' => 'User\UserDashborad\UserDashboardController@userServiceProductAddToCart'
    ]);

    Route::get('/user-service-product-add-to-cart-fetch', [
        'uses' => 'User\UserDashborad\UserDashboardController@userServiceProductAddToCartF'
    ]);


    Route::get('/user-service-product-cart', 'User\UserDashborad\ServiceProductCartController@index');
    Route::post('/user-service-product-cart', 'User\UserDashborad\ServiceProductCartController@store');
    Route::delete('/user-service-product-cart/{id}', 'User\UserDashborad\ServiceProductCartController@destroy');
    Route::post('/user-service-product-cart-increase/', 'User\UserDashborad\ServiceProductCartController@cartQuantityIncrease');
    Route::post('/user-service-product-cart-decrease/', 'User\UserDashborad\ServiceProductCartController@cartQuantityDecrease');
