...
@section('content')
    <section class="content" id="shopdata">
        <br>
        ...
        {{-- <div class="row">
            ...
            {{-- <div style="height: 150vh" id="infinite-list"></div> --}}
