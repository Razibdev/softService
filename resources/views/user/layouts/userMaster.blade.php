...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed text-sm " style="padding-right: 0 !important;">
    ...
    <div class="wrapper" id="app">
        ...
        <div class="content-wrapper" id="loaddatas">
