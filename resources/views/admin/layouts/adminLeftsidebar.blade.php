        ...
        <nav class="mt-2">
                ...
                @if (Auth::user()->hasPermission('balance'))
                    ...
                    <li class="nav-item has-treeview {{ session('lsbm') == 'balance' ? ' menu-open ' : '' }}">
                        ...
                        {{-- <ul class="nav nav-treeview">    
                          ...
                          <li class="nav-item ">
                              <a href="{{route('admin.jobPostOrder')}}" class="nav-link {{ session('lsbsm') == 'jobPostOrder' ? ' active ' : '' }}">
                                  <i class="nav-icon far fa-circle nav-icon"></i>
                                  <p>
                                      {{ __('All Job Post Order') }}
            ...
            @endif
                ...
                @endif
                  ...
                  <li class="nav-item has-treeview {{ session('lsbm') == 'softcomapplicationlist' ? ' menu-open ' : '' }}">
                    <a href="{{ route('admin.applicationlist') }}" class="nav-link ">
                        <i class="nav-icon fa fa-star nav-icon"></i>
                        <p>
                          {{ __('adminsidebar.applicationlist') }}
                        </p>
                    </a>
                </li>
